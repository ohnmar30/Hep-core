...
package org.openmrs.module.chaicore.test;
...
public class ReportingTestUtils {
	...
	/**
	 * Checks a standard cohort report
	 * @param expectedIds the set of expected patient ids
	 * @param data the report data
	 */
	public static void checkStandardCohortReport(Set<Integer> expectedIds, ReportData data) {
