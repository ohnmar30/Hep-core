...
import org.openmrs.module.chaicore.report.builder.CalculationReportBuilder;
...
public class ReportManager implements ContentManager {
	...
	@Autowired
	@Qualifier("chaicore.genericCalcReportBuilder")
	private CalculationReportBuilder calculationReportBuilder;

	/**
	 * @see org.openmrs.module.chaicore.ContentManager#getPriority()
	 */
	@Override
	...
	/**
	 * @see org.openmrs.module.chaicore.ContentManager#refresh()
	 */
	@Override
