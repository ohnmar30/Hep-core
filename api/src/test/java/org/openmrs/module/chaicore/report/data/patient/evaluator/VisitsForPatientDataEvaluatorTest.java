...
package org.openmrs.module.chaicore.report.data.patient.evaluator;
...
import org.openmrs.module.chaicore.test.StandardTestData;
import org.openmrs.module.chaicore.test.ReportingTestUtils;
import org.openmrs.module.chaicore.test.TestUtils;
import org.openmrs.module.chaicore.report.data.patient.definition.VisitsForPatientDataDefinition;
...
/**
 * Tests for {@link org.openmrs.module.chaicore.report.data.patient.evaluator.VisitsForPatientDataEvaluator}
 */
public class VisitsForPatientDataEvaluatorTest extends BaseModuleContextSensitiveTest {
	...
	@Before
	public void setup() {
		VisitType initial = MetadataUtils.existing(VisitType.class, StandardTestData._VisitType.INITIAL_HIV);

		visitP7a = TestUtils.saveVisit(TestUtils.getPatient(7), initial, TestUtils.date(2012, 1, 1), TestUtils.date(2012, 1, 2));
		visitP7b = TestUtils.saveVisit(TestUtils.getPatient(7), initial, TestUtils.date(2012, 2, 1), TestUtils.date(2012, 2, 2));
	...
	/**
	 * @see org.openmrs.module.chaicore.report.data.patient.evaluator.VisitsForPatientDataEvaluator#evaluate(org.openmrs.module.reporting.data.patient.definition.PatientDataDefinition, org.openmrs.module.reporting.evaluation.EvaluationContext)
	 */
	@Test
